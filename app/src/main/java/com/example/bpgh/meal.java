...
public class meal extends AppCompatActivity {
    ...
    private String myUrl = "http://bukyo.gwe.hs.kr/sFoodList.do?m=0603&s=bukyogh";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWebView.loadUrl(myUrl + "http://bukyo.gwe.hs.kr/sFoodList.do?m=0603&s=bukyogh"); // 접속 URL
